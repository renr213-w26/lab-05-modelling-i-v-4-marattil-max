...
d.  Use the visualization to describe the relationship between the two variables.
    ...
    **There seems to be a stong negative relationship between divergence time and parsitism similary between the 2 species. As time increase and the species evolve apart from one another in-terms of genetic and physical similarity, the measure of parasitic similarity has a decrease.**
